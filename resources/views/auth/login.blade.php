        ...
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            ...
            <form method="POST" action="{{ route('login') }}" class="mx-auto max-w-lg rounded-lg border">
                ...
                <div class="flex flex-col gap-4 p-4 md:p-8">
                    ...
                    <button type="submit"
                        class="block rounded-lg bg-indigo-700 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-500 ease-in-out hover:bg-indigo-600 focus-visible:ring active:bg-indigo-600 md:text-base">
                    ...
                    <button
                        class="flex items-center justify-center gap-2 rounded-lg bg-blue-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-blue-300 transition duration-500 ease-in-out hover:bg-blue-600 focus-visible:ring active:bg-blue-700 md:text-base">
                ...
                <div class="flex items-center justify-center bg-gray-100 p-4">
                    <p class="text-center text-sm text-gray-500">¿No tienes una cuenta? <a
                            href="{{ route('register') }}"
                            class="text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">Registrarme</a>
                    </p>
                </div>
            </form>
        </div>
