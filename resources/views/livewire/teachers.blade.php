            ...
            <main class="h-full overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    <div class=' w-full overflow-hidden shadow-xl'>
                        ...
                        <table
                            ...
                            <thead class="bg-gray-900">
                                <tr class="text-white text-left">
                                    ...
                                    <th class="font-semibold text-sm capitalize px-6 py-4"> name </th>
                                    <th class="font-semibold text-sm capitalize px-6 py-4"> email </th>
                                    <th class="font-semibold text-sm capitalize px-6 py-4"> phone </th>
                        ...
                        <div class="m-2 p-2">{{ $teachers->links() }}</div>
                        <!-- MODAL -->
                        @if ($isOpen)
