                        ...
                        <div class="mt-4">
                            ...
                            <div x-show="activeTab === '2'">
                                ...
                                <div id="between-dates-chart-table">
                                    <div class="flex flex-col space-y-2 md:space-y-0 md:flex-row md:items-center my-10">
                                        <div class="w-full px-3 md:w-1/3 mb-3 sm:mb-0 ">
                                            <select wire:model="selectedUser" wire:change="updateCategoriesData"
                                                class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option value="">Select User</option>
                                                @if (auth()->user()->hasRole('Admin'))
                                                    @foreach ($users as $user)
                                        ...
                                        <div class="w-full px-3 md:w-1/3 mb-3 sm:mb-0 ">
                                            <select wire:model="selectedYear" wire:change="updateCategoriesData"
                                                class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option value="">Select Year</option>
                                                @foreach ($years as $year)
                                                    <option value="{{ $year }}">{{ $year }}</option>
                                        ...
                                        <div id="chart-container" class="my-5">
                                                ...
                                                <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex items-center">
                                                            <span
                                                                class="inline-block w-3 h-3 mr-1 bg-teal-600 rounded-full"></span>
                                                            <span class="font-semibold">{{ $totalGeneral }}</span>
                                                        </div>
                                                        <div class="flex items-center">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex items-center">
                                                            <span
                                                                class="inline-block w-3 h-3 mr-1 bg-purple-600 rounded-full"></span>
                                                            <span
                                                                class="font-semibold">{{ $categoryNameSelected->category_name }}</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <script>
                                                ...
                                                var dataBar = {
                                                    ...
                                                    datasets: [{
                                                            label: "{{ $categoryNameSelected->category_name }}",
                                                            backgroundColor: "#0694a2",
                                                            borderColor: "#0694a2",
                                                            data: [
                            ...
                            <div x-show="activeTab === '3'">
                                ...
                                <div id="between-dates-chart-table">
                                    <div
                                        ...
                                        <div class="w-full px-3 md:w-1/3 mb-3 sm:mb-0 ">
                                            <select wire:model="selectedUser" wire:change="updateBetweenData"
                                                class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option value="">Select User</option>
                                                @if (auth()->user()->hasRole('Admin'))
                                                    @foreach ($users as $user)
