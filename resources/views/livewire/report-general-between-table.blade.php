     ...
     <div id="between-dates-report-table">
         ...
         <div class="flex flex-col space-y-2 md:space-y-0 md:flex-row md:items-center my-10">
             <div class="w-full px-3 md:w-1/3 mb-3 sm:mb-0 ">
                 ...
                 <div wire:ignore>
                     <select id="selectUser3" style="width: 100%" wire:model="selectedUser3" wire:change="updateBetweenData"
                         wire:ignore>
         ...
         @if ($showData3)
             <div class="my-10 flex justify-end space-x-2">
                 <x-button wire:click="openModal3">
                             ...
                             <form>
                                 ...
                                 <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                     ...
                                     <span class="mt-3 flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto">
                                         <button wire:click="closeModal3()" type="button"
 ...
 <script>
     document.addEventListener('livewire:load', function() {
         ...
         Livewire.on('emailSent3', function() {
