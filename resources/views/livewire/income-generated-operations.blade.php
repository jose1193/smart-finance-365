                ...
                <div class="container px-6 mx-auto grid">
                    ...
                    <div
                        ...
                        <div class="flex items-center">
                            ...
                            <x-slot name="title">
                                {{ __('messages.income_generated_operations') }}
                            </x-slot>
                            <a href="{{ route('incomes') }}">
                                <span> {{ __('messages.income_generated_operations') }}</span></a>
                        </div>
        ...
        Livewire.on('deleteData', function(id, description) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.emitTo('income-generated-operations', 'delete', id);
                    Swal.fire(
    ...
    document.addEventListener('livewire:load', function() {
        Livewire.on('showConfirmation', () => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.emitTo('income-generated-operations',
