  <footer class="px-3 pt-4 lg:px-9 border-t-2 bg-gray-50">
      <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="sm:col-span-2">
              <a href="#" class="inline-flex items-center">
                  <img src="{{ asset('img/favicon/favicon-192x192.png') }}" alt="logo" class="h-16 w-20">
                  <span class="ml-2 text-xl font-bold tracking-wide text-gray-800">Smart Finance 365</span>
              </a>
          ...
          <div class="flex flex-col gap-2 text-sm">
              <p class="text-base font-bold tracking-wide text-gray-900">{{ __('messages.footer_company') }}</p>
              <a href="#">{{ __('messages.footer_about') }}</a>
              <a href="#">{{ __('messages.footer_help_center') }}</a>
              <a href="#">{{ __('messages.footer_pricing') }}</a>
              <a href="{{ route('latest-posts') }}">Blog</a>

              <p class="text-base font-bold tracking-wide text-gray-900">Legal</p>
              <a href="#">{{ __('messages.footer_terms_of_service') }}</a>
              <a href="#">{{ __('messages.footer_privacy_policy') }}</a>
              <a href="#">{{ __('messages.footer_cookies_policy') }}</a>

          </div>

          <div>
              <p class="text-base font-bold tracking-wide text-gray-900">
                  {{ __('messages.footer_download_available_on') }}</p>
              <div class="flex flex-1 gap-4 hover:cursor-pointer">
                  <img src="{{ asset('img/playstore.svg') }}" width="130" height="110" alt="" />
                  <img src="{{ asset('img/ios.svg') }}" width="130" height="110" alt="" />
              </div>

              <p class="text-base font-bold tracking-wide text-gray-900">{{ __('messages.footer_contact') }}</p>
              <div class="flex">

                  <a href="#" title="send email">support@smart-finance365.com</a>
              </div>
          </div>
      ...
      <div class="py-7 border-t border-gray-200">
          <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              <span class="text-sm text-gray-500 ">© Copyright {{ date('Y') }} - Smart Finance 365.
                  {{ __('messages.footer_copyright') }}</span>
              <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                  ...
                  <a href="javascript:;"
                      class="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#0077b5]  hover:bg-gray-900 ">

                      <svg width="16" height="16" class=" text-white" xmlns="http://www.w3.org/2000/svg"
