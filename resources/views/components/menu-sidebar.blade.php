             ...
             <li class="relative px-6 py-3">
                 <button
                     ...
                     <span class="inline-flex items-center">
                         ...
                         <span class="ml-4">Rates Coins</span>
                     </span>
             ...
             <li class="relative px-6 py-3">
                 ...
                 <template x-if="isPagesMenuOpen3">
                     <ul x-transition:enter="transition-all ease-in-out duration-300"
                         ...
                         <li
                             class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                             <a class="w-full" href="{{ route('general-report') }}">
                                 General
                             </a>
                         </li>
             ...
             <li class="relative px-6 py-3">
                 ...
                 <template x-if="isPagesMenuOpen5">
                     <ul x-transition:enter="transition-all ease-in-out duration-300"
                         ...
                         <li
                             class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                             <a class="w-full" href="{{ route('currency') }}">Currency Exchange Rates</a>
                         </li>
                         <li
                             class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                             <a class="w-full" href="{{ route('calculator') }}">
             ...
             <li class="relative px-6 py-3">
                 ...
                 <template x-if="isPagesMenuOpen3">
                     <ul x-transition:enter="transition-all ease-in-out duration-300"
                         ...
                         <li
                             class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                             <a class="w-full" href="{{ route('general-report') }}">General</a>
                         </li>
