    ...
    <x-slot name="title">
        <div>
            <a href="#" id="backButton"
                class="my-5 bg-blue-500 duration-500 ease-in-out hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                Go Back
            </a>
            <script>
                document.getElementById('backButton').addEventListener('click', function(e) {
                    e.preventDefault(); // Evita que el enlace se comporte normalmente
