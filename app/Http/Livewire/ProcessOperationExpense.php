 ...
 public function render()
{
    ...
    ->whereHas('category', function($query) {
        $query->where('main_category_id', 2);
    })
 ...
 public function currencyChanged()
{
    ...
    public function edit($id)
    {
        ...
        ->leftJoin('process_budget_expenses', 'process_operations.id', '=', 'process_budget_expenses.process_operation_id')
...
{
    $budget = $processOperation->processBudgetExpenses()->first();
